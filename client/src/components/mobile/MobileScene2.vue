    ...
    export default {
        ...
        methods: {
            ...
            init() {
                ...
                window.addEventListener('click',() => {this.resetCircleAnimation()});
            ...
            circleAnimation() {
                ...
                setInterval(() => {
                    if(!this.isClicked) {
                        if(compter < this.sceneDiv.children.length +1) {
                            if(this.sceneDiv.children[compter] !== undefined) {
                                this.sceneDiv.children[compter].classList.add('mobile-scene-2__circle')
                            }
                            compter++;
                        } else {
